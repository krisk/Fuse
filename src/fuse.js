...
(function(global) {
        ...
        if (!path) {
            ...
            if (value) {
                if (!remaining && (typeof value === 'string' || typeof value === 'number')) {
                   ...
                   // We make the assumption that they want to compare the return of a function.
                   list.push(value());
    ...
    var Utils = {
        ...
        isArray: function(obj) {
            return (obj && Object.prototype.toString.call(obj) === '[object Array]') ? true : false;
        },
        isFunction: function(obj) {
            return (obj && Object.prototype.toString.call(obj) === '[object Function]') ? true : false;
        },
        isObject: function(obj) {
            return (obj && Object.prototype.toString.call(obj) === '[object Object]') ? true : false;
        },
        isString: function(obj) {
            return (obj && Object.prototype.toString.call(obj) === '[object String]') ? true : false;
        }
    };
    ...
    Fuse.prototype.search = function(pattern) {
        ...
        for (var i = 0; i < dataLen; i++) {
            if (Utils.isString(list[i])) {
                analyzeText(list[i], i, i);
            } else if (Utils.isFunction(list[i])) {
                analyzeText(list[i](), i, i);
            } else if (Utils.isObject(list[i])) {
                for (j = 0; j < searchKeysLen; j++) {
                    var objectFieldValue = options.getFn(list[i], searchKeys[j]);
                    if (objectFieldValue) {
                        if (Utils.isArray(objectFieldValue)) {
                            analyzeText(objectFieldValue[0], list[i], i);
                        }  else if (Utils.isString(objectFieldValue)) {
                            analyzeText(objectFieldValue, list[i], i);
                        }
                    }
                }
            }
        ...
        for (var j = 0, len = rawResults.length; j < len; j++) {
            replaceValue(j);
            results.push(getItem(j));
        }
