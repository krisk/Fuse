...
```html
<script src="https://cdn.jsdelivr.net/npm/fuse.js@6.5.1"></script>
```
...
```html
<script type="module">
  import Fuse from 'https://cdn.jsdelivr.net/npm/fuse.js@6.5.1/dist/fuse.esm.js'
</script>
```
...
```typescript
// @deno-types="https://deno.land/x/fuse@v6.5.1/dist/fuse.d.ts"
import Fuse from 'https://deno.land/x/fuse@v6.5.1/dist/fuse.esm.min.js'
```
