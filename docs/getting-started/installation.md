...
```html
<script src="https://cdn.jsdelivr.net/npm/fuse.js@5.0.7-beta"></script>
```
...
```html
<script type="module">
  import Fuse from 'https://cdn.jsdelivr.net/npm/fuse.js@5.0.7-beta/dist/fuse.esm.browser.js'
</script>
```
