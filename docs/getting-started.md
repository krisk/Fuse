...
```html [script tag]
<script src="https://cdn.jsdelivr.net/npm/fuse.js@7.5.0"></script>
```
...
```typescript
// @deno-types="https://deno.land/x/fuse@v7.5.0/dist/fuse.d.ts"
import Fuse from 'https://deno.land/x/fuse@v7.5.0/dist/fuse.min.mjs'
```
