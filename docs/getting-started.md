...
```html
<script src="https://cdn.jsdelivr.net/npm/fuse.js@7.2.0"></script>
```
...
```html
<script type="module">
  import Fuse from 'https://cdn.jsdelivr.net/npm/fuse.js@7.2.0/dist/fuse.mjs'
</script>
```
...
```typescript
// @deno-types="https://deno.land/x/fuse@v7.2.0/dist/fuse.d.ts"
import Fuse from 'https://deno.land/x/fuse@v7.2.0/dist/fuse.min.mjs'
```
